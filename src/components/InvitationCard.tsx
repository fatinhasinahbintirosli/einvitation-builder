                ...
                <div className="my-auto w-full py-1 flex flex-col items-center justify-center">
                  ...
                  {slide.type === 'intro' && (
                    <div className="space-y-3.5 w-full flex flex-col items-center">
                      ...
                      <p className="text-[13px] text-slate-700 leading-relaxed max-w-[305px] mx-auto min-h-[48px] font-normal">
                      ...
                      <h3 className="text-xl font-bold tracking-wide" style={{ color: data?.theme?.primaryColor || '#2d4a3e', fontFamily: 'Playfair Display, serif' }}>
                        {isCurrent ? <TypewriterText text={slide.subtitle || ''} speed={55} delay={800} /> : slide.subtitle}
                      </h3>
                    </div>
                  )}
                  ...
                  {slide.type === 'location' && slide.locationDetails && (
                    <div className="space-y-4 max-w-[310px] w-full flex flex-col items-center">
                      ...
                      <div className="space-y-1.5 text-center">
                        <h3 className="text-lg font-bold" style={{ color: data?.theme?.primaryColor || '#2d4a3e' }}>
                          {slide.locationDetails.venueName}
                        </h3>
                        <p className="text-[13px] text-slate-700 leading-relaxed whitespace-pre-line min-h-[48px]">
                  ...
                  {slide.type === 'tentative' && (
                    <div className="w-full space-y-3.5 max-w-[300px]">
                      {slide.timeline?.map((item, tIdx) => (
                        <div key={tIdx} className="flex justify-between items-center border-b border-dashed border-amber-900/25 pb-2.5 text-xs sm:text-[13px]">
                          <span className="font-bold text-amber-900 shrink-0">{item.time}</span>
                  ...
                  {slide.type === 'image_qr' && (
                    <div className="space-y-3.5 max-w-[300px] flex flex-col items-center">
                      ...
                      <h4 className="text-base font-bold text-slate-900" style={{ color: data?.theme?.primaryColor || '#2d4a3e' }}>
                  ...
                  {slide.type === 'guestbook' && (
                    <div className="space-y-3.5 max-w-[300px] w-full text-center">
                      ...
                      <h4 className="text-base font-bold" style={{ color: data?.theme?.primaryColor || '#2d4a3e' }}>
                  ...
                  {slide.type === 'thank_you' && (
                    <div className="space-y-3.5 max-w-[300px] mx-auto">
                      ...
                      <p className="text-[13px] leading-relaxed text-slate-700 min-h-[48px]">
